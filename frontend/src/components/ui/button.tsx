...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-orange-500 to-red-600 text-white shadow-[0_0_20px_rgba(255,80,0,0.4)] hover:shadow-[0_0_40px_rgba(255,80,0,0.6)] hover:scale-[1.02] border border-white/10",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-orange-500/30 bg-black/40 backdrop-blur-md text-orange-500 hover:bg-orange-500/10 hover:border-orange-500/60 hover:text-orange-400 shadow-[0_0_15px_rgba(255,100,0,0.1)]",
        secondary:
      ...
      size: {
        ...
        lg: "h-12 rounded-md px-8 text-base font-semibold tracking-wide",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
